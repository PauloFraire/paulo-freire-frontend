        ...
        <section className='md:container mx-auto my-10 p-2'>
            ...
            <div className="flex container mx-auto justify-center my-10">
                <div className="grid md:grid-cols-2 max-w-5xl gap-2">
                    <a href="http://scielo.sld.cu/scielo.php?pid=S1992-82382019000100019&script=sci_arttext" className="inline-flex items-center justify-center p-5 text-base font-medium text-white rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white gap-2 shadow-sm">
                    ...
                    {/*  */}
                    <a href="https://dialnet.unirioja.es/servlet/articulo?codigo=5758752" className="inline-flex items-center justify-center p-5 text-base font-medium text-white rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white gap-2 shadow-sm">
                    ...
                    {/*  */}
                    <a href="https://dialnet.unirioja.es/servlet/articulo?codigo=7169074" className="inline-flex items-center justify-center p-5 text-base font-medium text-white rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white gap-2 shadow-sm">
                    ...
                    {/*  */}
                    <a href="https://dialnet.unirioja.es/servlet/articulo?codigo=7169074" className="inline-flex items-center justify-center p-5 text-base font-medium text-white rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white shadow-sm">
                        <CiLink className="h-16 w-16 text-purple-400" />
                        <div>
                            <p className="w-full">La Jornada Veracruz - La Escuela Infinita</p>
                            <p>
                ...
                <div className='grid md:grid-cols-2 xl:grid-cols-3 gap-2 grid-cols-1'>
                    ...
                    <div className='flex'>
                        <a href={pdf2} className="block max-w-sm p-6 bg-gradient-to-tr from-orange-300 to-yellow-200 border rounded-lg shadow hover:bg-gray-100 flex-grow hover:scale-105 transition-all duration-300 ease-in-out ">
                            ...
                            <p className="font-normal">Este artículo aborda un tema de total vigencia para la educación: las relaciones existentes entre educación y globalización desde una visión crítica.</p>
                        </a>
                    </div>
                    {/*  */}
                    <div className='flex'>
                        <a href={pdf3} className="block max-w-sm p-6 bg-gradient-to-tr from-pink-300 to-yellow-100 border rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 hover:scale-105 transition-all duration-300 ease-in-out ">
                            ...
                            <p className="font-normal">Este trabajo tiene por objetivo destacar algunos momentos del desarrollo
                    ...
                    <div className='flex'>
                        <a href={pdf4} className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 bg-gradient-to-tr from-blue-300 to-sky-100 hover:scale-105 transition-all duration-300 ease-in-out ">
                            <FaRegFilePdf className='text-center mx-auto text-red-600 my-2' />
                            <h5 className="mb-2 text-2xl font-bold tracking-tight">La investigación cualitativa en educacion_necesidad y reto para los modelos pedagogicos contemporaneos.pdf</h5>
                            <p className="font-normal">En el presente artículo se plantean los presupuestos básicos, los objetivos e interrogantes de la
