        ...
        <section className='history mt-10' >
            ...
            <div className='flex flex-col justify-center items-center text-center'>
                <div className='max-w-4xl'>
                    ...
                    <p className="my-10 text-lg  mx-auto leading-relaxed text-slate-200 ">
                    ...
                    <p className="my-8 text-lg  mx-auto relaxed text-slate-200 ">
                    ...
                    <div className=''>
                        <Link to={'/historia'} className='w-full py-3 font-medium text-white bg-yellow-600 hover:bg-yellow-700 rounded-sm border-indigo-500 hover:shadow inline-flex space-x-2 items-center justify-center transition-all duration-300 ease-in-out'>
                            Leer más
                        </Link>
